...
The published name is `gaffr`, because `gaff` was taken. Both commands
install together. Type `gaff`.
...
[releases page](https://github.com/cjohnhanson/gaff/releases) holds all
of them.
