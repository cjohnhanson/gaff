...
[releases page](https://github.com/cjohnhanson/gaff/releases).
...
The name to publish under is `gaffr`, because `gaff` was already
taken. Both commands install together, so `gaff` is what you type.
